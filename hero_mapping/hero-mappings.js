...
export const HERO_DISPLAY_TO_SLUG = {
    "Infernus": "inferno",
    "Seven": "gigawatt",
    "Vindicta": "hornet",
    "Lady Geist": "ghost",
...
export const HERO_SLUG_TO_DISPLAY = {
    "inferno": "Infernus",
    "gigawatt": "Seven",
    "hornet": "Vindicta",
    "ghost": "Lady Geist",
 ...
 */
export function getHeroSlug(displayName) {
 ...
 */
export function getHeroClassName(heroId) {
 ...
 */
export function getHeroColor(heroId) {
 ...
 */
export function isHeroPlayable(heroId) {
